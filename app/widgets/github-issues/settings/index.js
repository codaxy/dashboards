...
export default (
	<cx>
        ...
        >
			<ValidationGroup layout={LabelsLeftLayout} invalid:bind="$data.settings.invalid">
                <TextField
            ...
            <FlexRow putInto="footer" spacing justify="end">
                <Button mod="primary" onClick="save" disabled:bind="$data.settings.invalid">Save</Button>
